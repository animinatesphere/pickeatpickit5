          ...
          >
            <div className="bg-gradient-to-br from-green-600 to-green-800 p-8 text-white relative overflow-hidden">
              ...
              <div className="flex justify-between items-center relative z-10">
                <div>
                  <h3 className="font-black  uppercase tracking-tighter text-2xl">Operational Intel</h3>
            ...
            <div className="p-8 bg-gray-50/50">
              <div className="text-center">
                ...
                <h4 className="font-black  uppercase text-gray-800 text-lg tracking-tight">Need Support?</h4>
            ...
            <div className="p-6 bg-white border-t border-gray-100">
              <div className="flex items-center justify-center gap-3">
                ...
                <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest ">System Online: Encrypted Connection</span>
              </div>
            </div>
          </motion.div>
        )}
