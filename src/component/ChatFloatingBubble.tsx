...
//                     Operational Intel
//                   </h3>
//                   <p className="text-[10px] font-bold text-green-200 uppercase tracking-widest mt-1">
//                     Real-time Comms Active
//                   </p>
//                 </div>
//                 <button
...
//                 </div>
//                 <h4 className="font-black  uppercase text-gray-800 text-lg tracking-tight">
//                   Need Support?
//                 </h4>
//                 <p className="text-xs text-gray-400 mt-3 font-bold leading-relaxed">
//                   Connect with vendors, riders, and support staff over a secure
//                   channel.
//                 </p>
...
//                   to={getInboxPath()}
//                   onClick={() => setIsOpen(false)}
//                   className="mt-8 w-full py-5 bg-green-600 text-white rounded-2xl font-black  uppercase tracking-widest text-xs flex items-center justify-center gap-3 hover:bg-green-700 transition-all shadow-xl shadow-green-600/20 active:scale-95"
//                 >
