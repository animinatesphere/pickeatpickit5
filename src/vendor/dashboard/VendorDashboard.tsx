    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-white dark:bg-gray-950 transition-colors duration-300">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 font-bold font-inter italic uppercase tracking-widest ">
            Loading Dashboard...
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 dark:from-green-700 dark:to-green-800 text-white px-6 py-4 shadow-lg sticky top-0 z-20">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="transition-all">
            <h1 className="text-2xl font-bold font-inter italic tracking-tighter uppercase">
              {vendorInfo?.business_name || "My Dashboard"}
            </h1>
            <p className="text-green-100 dark:text-green-200 text-sm mt-1 font-medium">
              Welcome back, Chef!
            </p>
          </div>
          ...
          {statCards.map((stat, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 text-xs font-bold uppercase tracking-widest mb-1">
                  {stat.label}
                </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6 border border-transparent dark:border-gray-800 transition-all">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link
                  to="/menu"
                  className="text-green-600 dark:text-green-400 font-bold text-sm flex items-center gap-1 uppercase italic tracking-widest"
                >
              ...
              <div className="space-y-4">
                {popularItems.map((item, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800 transition-all"
                  >
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-gray-800 dark:text-gray-100 font-inter tracking-tight">
                        {item.name}
                      </h3>
                      <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">
                        {item.category}
                      </p>
                      <p className="text-sm font-bold text-green-600 dark:text-green-400 mt-1 font-inter">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6 border border-transparent dark:border-gray-800 transition-all">
              ...
              <div className="space-y-3">
                {recentOrders.map((order, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-4 rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800/30 transition-all"
                  >
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-gray-800 dark:text-gray-100 font-inter">
                          {order.id}
                        </span>
                      ...
                      <p className="text-[10px] text-gray-500 dark:text-gray-500 mt-1 font-bold uppercase tracking-widest">
                        {order.time}
                      </p>
                    </div>
                    <span
                      className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase italic tracking-widest ${
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-green-600 to-green-700 dark:from-green-700 dark:to-green-800 rounded-3xl shadow-lg p-8 text-white text-center border-4 border-white/10 relative overflow-hidden group">
              ...
              <h2 className="text-lg font-bold mb-4 font-inter italic uppercase tracking-tighter relative z-10">
                Store Rating
              </h2>
              <div className="text-6xl font-bold mb-2 font-inter italic relative z-10">
              ...
              <p className="text-green-100 dark:text-green-200 text-xs font-medium relative z-10">
                {stats.avgRating > 0
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-6 border border-transparent dark:border-gray-800 transition-all">
              <h2 className="text-lg font-bold text-gray-800 dark:text-gray-100 mb-4 font-inter italic uppercase tracking-tighter">
                Quick Actions
              </h2>
              <div className="space-y-3 font-inter">
                <button
                  onClick={() => (window.location.href = "/orders")}
                  className="w-full py-4 bg-green-600 dark:bg-green-700 text-white rounded-xl font-bold hover:bg-green-700 dark:hover:bg-green-800 transition-all shadow-lg active:scale-95 uppercase italic tracking-widest text-xs"
                >
                  Active Orders
                </button>
                <button
                  onClick={() => (window.location.href = "/menu")}
                  className="w-full py-4 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-xl font-bold hover:bg-gray-200 dark:hover:bg-gray-700 transition-all active:scale-95 uppercase italic tracking-widest text-xs"
                >
                  Edit Menu
                </button>
              </div>
