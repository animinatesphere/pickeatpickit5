          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-5">
              {[
                {
                  label: "Active Orders",
                  value: `${stats?.activeOrders || 0} Orders`,
                  color: "bg-blue-400",
                },
                {
                  label: "Completed Orders",
                  value: `${stats?.completedOrders || 0} Orders`,
                  color: "bg-blue-600",
                },
                {
        ...
        <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-xl p-8 border border-transparent dark:border-gray-800 transition-all">
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              {
                label: "Clients",
                value: stats?.userCounts?.clients || 0,
                color: "bg-green-600",
              },
              {
                label: "Vendors",
                value: stats?.userCounts?.vendors || 0,
                color: "bg-blue-600",
              },
              {
                label: "Riders",
                value: stats?.userCounts?.riders || 0,
                color: "bg-orange-600",
              },
            ].map((item) => (
              <div
